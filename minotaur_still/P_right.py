...
impossible_human_movement=[((1, 2), (1, 3)),
                           ((2, 2), (2, 3)),
                           ((3, 2), (3, 3)),
                           ((2, 4), (2, 5)),
                           ((3, 4), (3, 5)),
...
def row_function(row, i):
    ...
    next_human_position = (hum_row, hum_col+1)
    ...
    candidate_next_states.append((human_position, minotaur_position))
